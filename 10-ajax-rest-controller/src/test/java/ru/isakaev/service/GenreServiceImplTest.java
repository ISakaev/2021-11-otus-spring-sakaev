...
class GenreServiceImplTest {
    ...
    @Test
    void shouldGetGenreByIdFromService() throws MyException {
        when(genreRepository.findById(1L)).thenReturn(Optional.of(genre));
        Genre genre1 = genreService.getGenre(this.genre.getId());
        assertThat(genre1.getName()).isEqualTo(genre.getName());
    }

    @Test
    void shouldSaveAvailableGenre() throws MyException {
    ...
    @Test()
    void shouldDeleteGenre() throws MyException {
        when(genreRepository.findById(1L)).thenReturn(Optional.of(genre));
